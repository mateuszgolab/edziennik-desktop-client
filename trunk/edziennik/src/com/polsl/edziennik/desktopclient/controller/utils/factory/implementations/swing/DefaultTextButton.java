...
/**
 * 
 * Klasa implementuj¹ca interfejs IButton ,dostarcza standardowy przycisk
 * tekstowy swinga
 * 
 * @author Mateusz Go³¹b
 * 
 */
public class DefaultTextButton implements IButton {
	...
	public JButton getButton(String name, String hint) {
		JButton b = new JButton((component.getString(name)));
		b.setEnabled(true);
